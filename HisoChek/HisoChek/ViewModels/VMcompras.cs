...
{
    public class VMcompras : BaseVistaModelo
    {
        #region VARIABLES
        readonly string _Texto;
        int _index;
        ...
        public VMcompras(INavigation navigation, StackLayout Carrilderecha, StackLayout Carrilizquierda)
        {
            ...
            _ = Mostrarproductos(Carrilderecha, Carrilizquierda);
            _IsvisiblePaneldetallecompra = false;
        }
        #endregion
        #region OBJETOS
        ...
        public void Dibujarproductos(Mproductos item, int index, StackLayout Carriderecha, StackLayout Carrilizquierda)
        {
            ...
            tap.Tapped += async (object sender, EventArgs e) =>
            {
                ...
                SharedTransitionNavigationPage.SetTransitionSelectedGroup(page, item.ProductID);
                await Navigation.PushAsync(new Carrito(item));
